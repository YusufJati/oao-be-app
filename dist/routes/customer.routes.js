...
const getCustomerController = __importStar(require("../controllers/customer/customer.get"));
const postCustomerController = __importStar(require("../controllers/customer/customer.post"));
